...
Lichuan CL57E-4A 4-axis closed-loop stepper drive | [lichuan](../src/devices/lcec_lichuan.c) | 0xa79:0x00006100 | Stepper Drive | Untested, configuration shared by Dil300 on linuxcnc.org forum (post 346506) | 4 axes via CiA 402 multiaxis pattern (SDO offset 0x800, PDO index increment 0x10).
...
[Beckhoff EL2522 2Ch. Pulse Train Output](http://www.beckhoff.com/EL2522) | [el2522](../src/devices/lcec_el2522.c) | 0x2:0x09da3052 | Digital Output |  | 
...
[IL2301-B110 Coupler Box, 4-channel digital input + 4-channel digital output, EtherCAT, 24 V DC, 3 ms, 0.5 A, M12](http://www.beckhoff.com/IL2301-B110) | [il2301](../src/devices/lcec_il2301.c) | 0x2:0x08FD3094 | Digital Input/Output | Tested and working @mintracer | 
...
[Schneider Electric Lexium 28 (LXM28E) EtherCAT servo drive](https://www.se.com/ww/en/product-range/62092-lexium-28/) | [schneider](../src/devices/lcec_schneider.c) | 0x800005a:0x00096030 | Servo Drive | Identity, PDO map and 0x6502 read from a live drive at PREOP 2026-08-13 (revision 0x00030006). No motor on our bench, not brought to OP. | CoE and FoE, but SDO-Info is NOT supported: the object dictionary reads back empty, so a master cannot enumerate it. 0x6502 reads 0x000000ed - pp, pv, tq, hm, ip and csp, with NO csv and NO cst, unlike the three other vendors on our bench which all answer 0x000003ad. One RxPDO and one TxPDO (0x1600/0x1a00) carrying 5 and 6 entries as shipped, pure CiA 402 with no vendor objects. DC system time transmission delay 1140 ns; no ESI available, so DC is not preset.
[Mitsubishi MR-J4 servo drive, TM (EtherCAT) network type](https://www.mitsubishielectric.com/fa/products/drv/servo/) | [mitsubishi](../src/devices/lcec_mitsubishi.c) | 0xa1e:0x00000201 | Servo Drive | Identity, PDO map and 0x6502 = 0x03ad read from a live drive at PREOP 2026-08-13 (MR-J4-20TM, revision 0x00020002). No motor on our bench, not brought to OP. | CoE and FoE. One RxPDO and one TxPDO (0x1c12/0x1c13 hold a single entry each, 0x1600/0x1a00); as shipped they carry 12 and 14 entries, fuller than other vendors because Mitsubishi maps its own 0x2d01..0x2d03 Control DI, 0x2d11..0x2d13 Status DO and 0x2d20 velocity limit alongside the standard objects. SDO-Info works and returns 809 objects. No ESI available to us, so DC is not preset.
[Omron NX-ECC202 EtherCAT coupler for the NX modular I/O series](https://industrial.omron.eu/en/products/NX-ECC202) | [omron_nx](../src/devices/lcec_omron_nx.c) | 0x83:0x000000a6 | EtherCAT Coupler | PDO map read from live hardware 2026-08-21; the station runs in production via an equivalent generic config. Driver discovery verified offline against those recorded SDO answers; not yet run in-tree on the coupler. | Modular station head: identity is the same whatever NX units are mounted, so the process image is read from 0x1c12/0x1c13 at init instead of being hardcoded. Alignment entries (object 0x0000) are declared but get no pins. Digital units only; no DC (AL 0x0034 with dcConf).
